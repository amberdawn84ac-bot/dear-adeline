                    ...
                    <div className="p-4 border-b border-[var(--cream-dark)]">
                        <div className="flex flex-col gap-4">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl transition-all font-medium border ${show3D
                            ...
                            >
                                <Box className={`w-4 h-4 ${show3D ? 'animate-pulse' : ''}`} />
                                {show3D ? 'Back to Dashboard' : '3D Playground'}
                            </button>
                        </div>
                    </div>
            ...
            <main className="flex-1 flex flex-col min-h-screen max-h-screen overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-4 lg:p-6 no-scrollbar">
                    <div className="grid grid-cols-12 gap-6 h-full">
                        {show3D ? (
                            <div className="col-span-12 h-full lg:h-[calc(100vh-120px)] animate-in fade-in zoom-in duration-500">
                                <Scene3D />
                            </div>
                        ) : (
                            <>

 ...
 * 
 * USAGE:
 *   node scripts/upload-pdf.js <path-to-pdf> <document-title>
 * 
 * EXAMPLES:
 *   node scripts/upload-pdf.js ./flexner-report.pdf "The Flexner Report"
 *   node scripts/upload-pdf.js ./underground-education.pdf "Underground History of American Education"
 * 
 * REQUIREMENTS:
...
async function uploadPDF() {
    ...
    if (!filePath || !title) {
        console.log('\n❌ Usage: node scripts/upload-pdf.js <path-to-pdf> <document-title>');
        console.log('\nExample:');
        console.log('  node scripts/upload-pdf.js ./flexner-report.pdf "The Flexner Report"\n');
        process.exit(1);
    }
